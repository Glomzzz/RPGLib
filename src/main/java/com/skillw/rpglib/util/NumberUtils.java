...
public final class NumberUtils {
     ...
     */
    public static double format(double number, FixedData fixedData) {
        int fixedIntegerMax = fixedData.getIntegerMax();
        int fixedIntegerMin = fixedData.getIntegerMin();
        int fixedDecimalMax = fixedData.getDecimalMax();
        int fixedDecimalMin = fixedData.getDecimalMin();
        return format(number,fixedIntegerMax,fixedIntegerMin,fixedDecimalMax,fixedDecimalMin);
    }

    public static double format(double number) {
        return format(number, FixedData.getDefaultData());
    }
     ...
     */
    public static double getRandom(double start, double end, FixedData fixedData) {
        int fixedIntegerMax = fixedData.getIntegerMax();
        int fixedIntegerMin = fixedData.getIntegerMin();
        int fixedDecimalMax = fixedData.getDecimalMax();
        int fixedDecimalMin = fixedData.getDecimalMin();
        int fixedDecimalValue = fixedData.getDecimalValue();
        return getRandom(start,end,fixedIntegerMax,fixedIntegerMin,fixedDecimalMax,fixedDecimalMin,fixedDecimalValue);
    }
